...
<head>
    ...
    <title>Configurar Serviços</title>
</head>
<body>
    ...
    <main class="container">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="my-4">Todos os Serviços</h2>
            <a href="adicionar_servico.php" class="btn btn-success"><i class="bi bi-plus"></i>Novo Serviço</a>
        </div>
        <table class="table">
            ...
            <tbody class="align-middle">
                <tr>
                    ...
                    <td>Sem descrição..</td>
                    <td>
                        <a href="atualizar_servico.php" class="btn btn-primary"><i class="bi bi-pencil-square me-2"></i>Atualizar</a>
