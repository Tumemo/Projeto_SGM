...
<body>
    ...
    <main class="container">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="my-4">Todos os Blocos</h2>
            <a href="adicionar_bloco.php" class="btn btn-success"><i class="bi bi-plus"></i>Novo Bloco</a>
        </div>
        <table class="table">
            ...
            <tbody class="align-middle">
                <tr>
                    ...
                    <td>Sem descrição..</td>
                    <td>
                        <a href="atualizar_bloco.php" class="btn btn-primary"><i class="bi bi-pencil-square me-2"></i>Atualizar</a>
